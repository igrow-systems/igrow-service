...
import com.igrow.locservice.session.Participant.ParticipantState;
...
import com.igrow.subscriber.MessageHandler;
...
public class LocatorSession implements MessageHandler<Observation> {
	...
	public void handleMessage(Observation message) {
		...
		final com.igrow.model.Observation observation = com.igrow.model.Observation
				.newObservation(message);
		final Participant participant = mParticipants.get(observation
				.getDeviceId());
		if (observation.getType() == com.igrow.model.Observation.ObservationType.TYPE_LOCATION_ONLY) {
		...
		} else if (observation.getType() == com.igrow.model.Observation.ObservationType.TYPE_GNSS_CHANNEL) {
