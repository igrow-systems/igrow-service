...
/*
 * @(#)NotifyDeviceResponseProtobufWriter.java        
 *
...
public class NotifyDeviceResponseProtobufWriter implements
		MessageBodyWriter<DeviceProtoBuf.NotifyDeviceResponse> {

	@Override
	public void writeTo(DeviceProtoBuf.NotifyDeviceResponse response,
	...
	@Override
	public long getSize(DeviceProtoBuf.NotifyDeviceResponse response,
	...
	public boolean isWriteable(Class<?> type, Type typeParam,
		...
		return DeviceProtoBuf.NotifyDeviceResponse.class
