...
/*
 * @(#)FindLocalDevicesRequestProtobufWriter.java        
 *
...
public class FindLocalDevicesRequestProtobufWriter implements
		MessageBodyWriter<DeviceProtoBuf.FindLocalDevicesRequest> {

	@Override
	public void writeTo(DeviceProtoBuf.FindLocalDevicesRequest response,
	...
	@Override
	public long getSize(DeviceProtoBuf.FindLocalDevicesRequest response,
